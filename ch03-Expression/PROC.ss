...
(print
  (expval->num
    (value-of
      (let-exp (list 'f) (list (proc-exp 'x (diff-exp (var-exp 'x) (const-exp 11))))
...
(print
  (expval->num
    (value-of
      (call-exp
        (proc-exp 'f (call-exp (var-exp 'f) (call-exp (var-exp 'f) (const-exp 77))))
...
(print
  (expval->num
    (value-of
      (let-exp (list 'x) (list (const-exp 200))
        (let-exp (list 'f) (list (proc-exp 'z (diff-exp (var-exp 'z) (var-exp 'x))))
          (let-exp (list 'x) (list (const-exp 100))
            (let-exp (list 'g) (list (proc-exp 'z (diff-exp (var-exp 'z) (var-exp 'x))))
              (diff-exp
