    ...
    (value-of
      (let-exp '_even
        (proc-exp 'f
          (proc-exp 'g
            (proc-exp 'x
              (or-exp (zero?-exp (var-exp 'x))
                (not-exp
                  (call-exp
                    (call-exp
                      (call-exp (var-exp 'g) (var-exp 'g))
                      (var-exp 'f)
                    )
                    (var-exp 'x)
                  )
        ...
        (let-exp '_odd
          (proc-exp 'f
            (proc-exp 'g
              (proc-exp 'x
                (and-exp (not-exp (zero?-exp (var-exp 'x)))
                  (call-exp
                    (call-exp
                      (call-exp (var-exp 'g) (var-exp 'g))
                      (var-exp 'f)
          ...
          (let-exp 'even
            (proc-exp 'x
              (call-exp
                (call-exp
                  (call-exp (var-exp '_even') (var-exp '_even))
                  (var-exp '_odd')
                )
                (var-exp 'x)
              )
            ...
            (let-exp 'odd
              (proc-exp 'x
                (call-exp
                  (call-exp
                    (call-exp (var-exp '_odd') (var-exp '_odd))
                    (var-exp '_even)
                  )
                  (var-exp 'x)
                )
