...
(define cps-of-exps
  (lambda (exps builder)
    ; Listof(InpExp) * Listof(SimpleExp) -> TfExp
  ...
  (lambda (exp k-exp)
    (cases expression exp
      ...
      (zero?-exp (exp1)
        (cps-of-exp/ctx exp1
          (lambda (simple)
            (make-send-to-cont k-exp (cps-zero?-exp simple))
          )
        )
      )
      (null?-exp (exp1)
        (cps-of-exp/ctx exp1
          (lambda (simple)
            (make-send-to-cont k-exp (cps-null?-exp simple))
          )
        )
      )
      (number?-exp (exp1)
        (cps-of-exp/ctx exp1
          (lambda (simple)
            (make-send-to-cont k-exp (cps-number?-exp simple))
          )
        )
      )
      (equal?-exp (exp1 exp2)
        (cps-of-exp/ctx exp1
          (lambda (simple1)
            (cps-of-exp/ctx exp2
              (lambda (simple2)
                (make-send-to-cont k-exp (cps-equal?-exp simple1 simple2))
              )
            )
          )
        )
      ...
      (less?-exp (exp1 exp2)
        (cps-of-exp/ctx exp1
          (lambda (simple1)
            (cps-of-exp/ctx exp2
              (lambda (simple2)
                (make-send-to-cont k-exp (cps-less?-exp simple1 simple2))
              )
            )
          )
        )
      ...
      (greater?-exp (exp1 exp2)
        (cps-of-exp/ctx exp1
          (lambda (simple1)
            (cps-of-exp/ctx exp2
              (lambda (simple2)
                (make-send-to-cont k-exp (cps-greater?-exp simple1 simple2))
              )
            )
          )
        )
      ...
      (diff-exp (exp1 exp2)
        (cps-of-exp/ctx exp1
          (lambda (simple1)
            (cps-of-exp/ctx exp2
              (lambda (simple2)
                (make-send-to-cont k-exp (cps-diff-exp simple1 simple2))
              )
            )
          )
        )
      ...
      (mul-exp (exp1 exp2)
        (cps-of-exp/ctx exp1
          (lambda (simple1)
            (cps-of-exp/ctx exp2
              (lambda (simple2)
                (make-send-to-cont k-exp (cps-mul-exp simple1 simple2))
              )
            )
          )
        )
      ...
      (add1-exp (exp1)
        (cps-of-exp/ctx exp1
          (lambda (simple)
            (make-send-to-cont k-exp (cps-add1-exp simple))
          )
        )
      )
      (sum-exp (exps)
      ...
      (call-exp (rator rands)
        (cps-of-exp/ctx rator
          (lambda (simple)
            (cps-of-exps rands
              (lambda (simples)
                (cps-call-exp simple (append simples (list k-exp)))
              )
            )
          )
        )
      ...
      (car-exp (exp1)
        (cps-of-exp/ctx exp1
          (lambda (simple)
            (make-send-to-cont k-exp (cps-car-exp simple))
          )
        )
      )
      (cdr-exp (exp1)
        (cps-of-exp/ctx exp1
          (lambda (simple)
            (make-send-to-cont k-exp (cps-cdr-exp simple))
          )
        )
      )
      (cons-exp (exp1 exp2)
