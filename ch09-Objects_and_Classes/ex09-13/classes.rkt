          ...
          (filter
            (lambda (m-env)
              (cases method (cadr m-env)
                (a-method (final modifier vars body super-name field-names) final)
              )
            )
            super-m-env
          )
      ...
      (lambda (m-decl)
        (cases method-decl m-decl
          (a-method-decl (modifier method-name vars body)
            (list method-name
              (a-method #f modifier vars body super-name field-names)
            )
          )
          (a-final-method-decl (modifier method-name vars body)
            (list method-name
              (a-method #t modifier vars body super-name field-names)
            )
          )
        )
      )
